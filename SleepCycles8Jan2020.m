...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Repeat this part of the script for each of the type of data
EEG_fft = pop_loadset();
...
%% Step 4 - Relationship between SWA between different sections of the night
%% Step 4.1 Between 1st Hr and last Hr of sleep or 1st half and last half of sleep
